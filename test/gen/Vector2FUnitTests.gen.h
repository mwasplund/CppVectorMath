#pragma once
#include "Vector2FUnitTests.h"

TestState RunVector2FUnitTests()
{
	auto className = "Vector2FUnitTests";
	auto testClass = std::make_shared<VectorMath::UnitTests::Vector2FUnitTests>();
	TestState state = { 0, 0 };
