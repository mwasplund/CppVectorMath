#pragma once
#include "Vector4FUnitTests.h"

TestState RunVector4FUnitTests()
{
	auto className = "Vector4FUnitTests";
	auto testClass = std::make_shared<VectorMath::UnitTests::Vector4FUnitTests>();
	TestState state = { 0, 0 };
	...
	state += Soup::Test::RunTest(className, "Set_W", [&testClass]() { testClass->Set_W(); });
